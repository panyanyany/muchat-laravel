...
(
    ...
    first_time       datetime(3)       null,
    usd_spent        double  default 0 not null,
    usd_spent_limit  double  default 0 not null,
    api_key          varchar(64)       not null,
    status           tinyint default 0 not null,
    query_cnt        bigint  default 0 not null,
    credit_used      double  default 0 not null,
    credit_available double  default 0 not null,
    expires_at       datetime(3)       null,
    name             longtext          null,
